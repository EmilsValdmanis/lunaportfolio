...
const AdminLogin = () => {
  ...
  return (
    <form className="p-10 bg-gray-100 w-full max-w-md rounded-3xl flex flex-col gap-4 m-auto shadow-lg">
      ...
      />
      <button onClick={login} className="text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
    </form>
  )
}
